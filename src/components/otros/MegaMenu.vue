...
const megaMenuButtonRef = ref<HTMLButtonElement | null>(null)
...
const handleClickOutside = (event: MouseEvent) => {
  if (megaMenuButtonRef.value && !megaMenuButtonRef.value.contains(event.target as Node)) {
          ...
          <div class="flex w-full items-center justify-between px-4">
            <div>
              <button
                @click="toggleNavbar"
                id="navbarToggler"
                :class="{ navbarTogglerActive: open }"
                ...
                <ul class="block lg:flex">
                  <li class="relative" ref="megaMenuButtonRef">
                    ...
                    <div
                      ...
                      class="w-full lg:absolute lg:left-0 lg:top-full lg:w-[850px] lg:rounded-xl lg:shadow-lg"
                    >
                      <div class="rounded-t-xl bg-white p-2 lg:p-8 dark:bg-dark">
                        <div class="mb-8">
                          <h4 class="mb-1 text-base font-medium text-dark dark:text-white">
                            Resources
                          </h4>
                        ...
                        <div class="grid gap-y-2 lg:grid-cols-2 lg:gap-x-5">
                          <a
                            href="javascript:void(0)"
                            class="group flex flex-col gap-4 rounded-lg p-4 duration-200 hover:bg-gray-1 lg:flex-row dark:hover:bg-white/5"
                          >
                            ...
                            <div>
                              <h3
                                class="mb-1 text-base font-semibold text-dark duration-200 group-hover:text-primary dark:text-white dark:group-hover:text-primary"
                              >
                                About Company
                              </h3>
                              <p class="text-sm text-body-color dark:text-dark-6">
                      ...
                      <div class="rounded-b-xl bg-primary/5 px-8 py-[18px]">
                        <a
                          href="javascript:void(0)"
                          class="flex w-full items-center justify-center gap-2 text-base font-medium text-primary"
                        >
                          Learn More
                          <span>
                            <svg
