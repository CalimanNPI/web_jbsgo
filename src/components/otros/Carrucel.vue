  ...
  <section class="pb-20 pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px]">
    <div class="container mx-auto">
      <Swiper :slidesPerView="1" ref="sliderRef" @swiper="onSwiper">
        <template v-for="(item, index) in testimonialItems" :key="index">
          <SwiperSlide>
            <div class="relative flex justify-center">
              <div class="relative w-full pb-16 md:w-11/12 lg:w-10/12 xl:w-8/12">
                <div class="w-full items-center md:flex">
                  ...
                  <div class="w-full">
                    <div>
                      ...
                      <p
                        class="mb-11 text-base font-normal italic leading-[1.81] text-body-color dark:text-dark-6 sm:text-[22px]"
                      >
                        {{ item.details }}
                      </p>
        ...
        <div
          class="absolute left-0 right-0 z-10 flex items-center justify-center gap-5 sm:bottom-0"
        >
