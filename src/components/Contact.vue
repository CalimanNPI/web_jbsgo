...
<template>
  <section
    class="relative z-10 overflow-hidden py-20 lg:py-[120px] text-slate-900"
    id="contact"
  >
      ...
      <div class="flex flex-wrap -mx-4 lg:justify-between">
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <h2
              class="text-rose-700 mb-6 text-[25] font-bold uppercase sm:text-[30px] lg:text-[30px] xl:text-[30px]"
            >
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              >
                <svg
                  ...
                  height="32"
                  viewBox="0 0 24 24"
                  style="fill: rgba(190, 18, 60, 1); transform: ; msfilter: "
                >
                  <path
            ...
            <form @submit.prevent="sendEmail()">
              <TransitionGroup name="list" tag="ul">
                ...
                <div v-if="errors.length > 0">
                  <div
                    class="bg-red-100 border-l-4 border-red-800 text-red-700 p-4 rounded-lg"
                  >
              ...
              <div class="mb-6 mt-10">
                <input
                  ...
                  v-model="data.name"
                  class="border-rose-500 text-body-color focus:border-rose-500 w-full rounded border py-3 px-[14px] text-base outline-none"
                />
              </div>
              <div class="mb-6">
                <input
                  v-model="data.email"
                  type="email"
                  placeholder="Tú correo electrónicos"
                  class="border-rose-500 text-body-color focus:border-rose-500 w-full rounded border py-3 px-[14px] text-base outline-none"
                />
              </div>
              <div class="mb-6">
                <textarea
                  ...
                  rows="6"
                  placeholder="Tú mensage"
                  class="border-rose-500 text-body-color focus:border-rose-500 w-full resize-none rounded border py-3 px-[14px] text-base outline-none"
                ></textarea>
              </div>
              <div>
                <button
                  type="submit"
                  class="w-full p-3 text-white transition border rounded border-rose-500 bg-gradient-to-br from-rose-500 to-rose-900 focus:ring-4 focus:outline-none focus:ring-rose-500"
                >
                  Enviar Mensaje
                </button>
              </div>
