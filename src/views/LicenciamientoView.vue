<template>
      ...
      <div class="flex flex-wrap items-center sm:-mx-3">
        ...
        >
          ...
          >
            ...
            >
              <span class="block xl:inline">Licenciamiento y </span>
              <span class="block text-rose-700 xl:inline"
                >mayorista de Tecnología.</span
              >
            </h1>
            <p
              class="mx-auto text-base text-slate-200 sm:max-w-md lg:text-xl md:max-w-3xl"
            >
              <span class="font-semibold text-rose-700">JBS Go</span>
              actualmente es Partner registrado de diversas marcas para ofrecer
              un amplio abanico de soluciones a nuestros clientes.
            </p>
  ...
  <div class="w-full px-4 pt-16 pb-5 text-slate-800" id="faq">
    ...
    <div
      class="animate-loop-scroll group-hover:paused mx-auto w-full max-w-4xl justify-center items-center grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4"
    >
      <img
        alt=""
        class="h-20 mx-auto"
  ...
  <div
    class="relative z-0 flex flex-col py-16 lg:py-0 lg:flex-row bg-slate-900 text-slate-200"
  >
    <div
      class="relative w-full max-w-xl lg:w-1/2 px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl flex justify-center items-center"
    >
      <div class="absolute right-3 top-0 z-[-1]">
        <svg
          width="80"
          height="150"
          ...
          viewBox="0 0 300 300"
        >
          <circle cx="93.15" cy="104.37" r="83.92" fill="#be123c"></circle>
          <circle cx="248.81" cy="82.03" r="41.96" fill="#252634"></circle>
          <circle cx="196" cy="226.73" r="52.82" fill="#A5A6BC"></circle>
          <circle cx="47.8" cy="226.73" r="20.64" fill="#4e4f66"></circle>
        </svg>
      </div>
      <div class="absolute left-3 bottom-0 z-[-1]">
        <svg
          width="80"
          height="150"
          xmlns="http://www.w3.org/2000/svg"
  ...
  <section
    class="overflow-hidden bg-[url(/img/imgs/licencia/mapa.jpg)] bg-cover bg-top bg-no-repeat"
  >
    <div class="bg-black/50 p-8 md:p-12 lg:px-16 lg:py-24">
      <div class="flex justify-end">
        ...
        <p
          class=" max-w-lg text-white/90 font-bold md:mt-6 md:block md:text-lg md:leading-relaxed text-right"
        >
          Estamos asociados a una cadena de proveedores Partner de las mas
          grandes plataformas como lo es: GCN Group, la red más grande de
          canales B2B de distribuidores locales de Tecnología alrededor del
          mundo, lo que permite la distribucion de multimarcas en equipo y
          software.
        </p>
      </div>
    </div>
  ...
  <div
    class="relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0 bg-slate-900"
  >
    <div
    ...
    >
      <svg
        class="absolute left-0 hidden h-full text-slate-900 transform -translate-x-1/2 lg:block"
        viewBox="0 0 100 100"
        fill="currentColor"
    ...
    >
      <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
        <h2
          class="mb-5 font-sans text-3xl font-bold tracking-tight text-slate-50 sm:text-4xl sm:leading-none"
        >
          <span class="relative inline-block">
            <span class="relative">A diferencia</span>
          </span>
          de revendedores, <span class="text-rose-700">JBS Go</span> Ofrece
