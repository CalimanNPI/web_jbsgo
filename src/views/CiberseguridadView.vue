...
<template>
  ...
  <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-10 mt-5">
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl"> 
          <span class="relative whitespace-nowrap text-rose-700">
              ...
              <span class="relative">Ciberseguridad</span>
          </span>
          y Videovigilancia
      </h1>
      <p class="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
        Su seguridad y la de los que le rodean es prioridad. Pero también las pérdidas materiales afectan a 
        su negocio. Por ello le ofrecemos una gama de soluciones que atenderán este tipo de incidencias
      </p>
  </div>
    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-800 lg:text-3xl ">Evite situación de  <br>
                      <span class="relative whitespace-nowrap text-rose-700">riesgo</span>
                    </h1>
                    <div class="mt-2">
                        <span class="inline-block w-40 h-1 bg-rose-700 rounded-full"></span>
                        <span class="inline-block w-3 h-1 ml-1 bg-rose-700 rounded-full"></span>
                        <span class="inline-block w-1 h-1 ml-1 bg-rose-700 rounded-full"></span>
                    </div>
                </div>

                <div class="md:flex md:items-start md:-mx-4">
                    <span class="inline-block p-2 text-rose-700 bg-rose-100 rounded-xl md:mx-4 ">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize ">Video</h1>

                        <p class="mt-3 text-gray-500 ">
                          Disuaden a quienes planean cometer un ilícito al saber que están siendo grabados y obtenga el registro visual de lo que pasa en su establecimiento
                        </p>
                    </div>
                </div>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize ">Alarmas</h1>

                        <p class="mt-3 text-gray-500 ">
                          Reducen el tiempo de reacción para afrontar el problema. Con una oportuna intervención se pueden reducir pérdidas.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize">Bolardos</h1>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize ">Videovigilancia móvil</h1>

                        <p class="mt-3 text-gray-500 ">
                          Los sistemas avanzados de asistencia al conductor (ADAS) son una colección de tecnologías altamente desarrolladas creadas para mejorar la seguridad vial al permitir un entorno de conducción más seguro para conductores, pasajeros y peatones.                        </p>
                    </div>
                </div>
  ...
  <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:py-25 py-20" style='background-image: url("https://sandbox.elemisthemes.com/assets/img/map.png")'>
      ...
      <p class="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
        en esta área ha desarrollado alianzas estratégicas con proveedores de nivel internacional, lo que nos permite tener a 
        nuestro equipo de expertos siempre capacitados para la instalación, mantenimiento y mejoramiento de los sistemas de 
        seguridad, desde la concepción del proyecto hasta la materialización del mismo
      </p>
  </div>
  ...
  <div class="grid grid-cols-1 gap-12 md:grid-cols-1 lg:grid-cols-2 mx-4 py-20">
    <article class="max-w-2xl mx-auto space-y-12 ">
      <div class="w-full mx-auto space-y-4 text-center">
      	<p class="text-xl font-bold tracki text-rose-700 uppercase">CUCI</p>
      	<h1 class="text-4xl font-bold leadi md:text-5xl">Centro Universitario Cuautitlán Izcalli</h1>
      </div>
      <div class=""></div>
      <div class="pt-12 border-t border-rose-700 ">
      	<div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
      		...
      		<div class="flex flex-col">
      			...
      			<p class="">
              Instalación de cableado estructurado en salones para clases híbridas, preparación de gabinete para centro de datos
            </p>
      		</div>
      	</div>
    ...
    <article class="max-w-2xl   mx-auto space-y-12 ">
      <div class="w-full mx-auto space-y-4 text-center">
      	<p class="text-xl font-bold tracki text-rose-700 uppercase">UCI</p>
      	<h1 class="text-4xl font-bold leadi md:text-5xl">Universidad de Cuautitlán Izcalli Plantel Balcones del Valle</h1>
      </div>
      <div class=""></div>
      <div class="pt-12 border-t border-rose-700 ">
      	<div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
      		...
      		<div class="flex flex-col">
      			<h4 class="text-lg font-semibold"></h4>
      			<p class="">
              Instalación de cableado estructurado en salones para clases híbridas.          
            </p>
      		</div>
      	</div>
      	<div class="flex justify-center pt-4 space-x-4 align-center"></div>
