...
// <Breadcrumb greetingMessage="hello"/>
...
<template>
  ...
  <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-10 mt-5">
      <p  rel="noreferrer" class="border rounded-2xl py-1 px-4 text-slate-500 text-sm mb-5 hover:scale-105 transition duration-300 ease-in-out">
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl"> 
          <span class="relative whitespace-nowrap text-rose-700">
              ...
              <span class="relative">Energía</span>
          </span>
      ...
      <p class="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
        ...
        de ahí que todos los días nos preocupemos por cubrir las necesidades del cliente y orientarlo 
        para que tome las mejores decisiones en temas de seguridad.
      </p>
  </div>

  <hr class="my-12 mx-4 border-rose-700">

  <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5 mx-4">
  ...
  <section class="mx-auto flex max-w-lg flex-col px-4 py-10 lg:max-w-screen-xl lg:flex-row">
    ...
    <div class="">
      ...
      <h2 class="mb-10 max-w-lg text-4xl font-bold leading-snug lg:text-5xl lg:leading-snug">Energía y<span class="text-rose-700"> Sistemas de detección </span> de incendio</h2>
      <div class="grid gap-y-12 gap-x-8 lg:grid-cols-2">
        <div>
          <p class="mb-6 border-l-4 border-rose-700 pl-4 text-2xl leading-10">Sistemas detectores de incendios</p>
        ...
        <div>
          <p class="mb-6 border-l-4 border-rose-700 pl-4 text-2xl leading-10">Sistemas de inspección y rayos X</p>
          <p class="text-lg text-gray-800">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam nihil reprehenderit laboriosam, exercitationem consectetur deserunt aliquam ab maiores!</p>
        </div>
        <div>
          <p class="mb-6 border-l-4 border-rose-700 pl-4 text-2xl leading-10">Respaldo y protección de energía</p>
          <p class="text-lg text-gray-800">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam nihil reprehenderit laboriosam, exercitationem consectetur deserunt aliquam ab maiores!</p>
        </div>
        <div>
          <p class="mb-6 border-l-4 border-rose-700 pl-4 text-2xl leading-10">Equipo de seguridad y señalización</p>
          <p class="text-lg text-gray-800">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam nihil reprehenderit laboriosam, exercitationem consectetur deserunt aliquam ab maiores!</p>
        </div>
      </div>
    </div>
  ...
  <section class="p-4 lg:p-8 ">
	<div class="container mx-auto space-y-12">
		<div class="flex flex-col overflow-hidden rounded-md lg:flex-row">
			<img src="https://source.unsplash.com/640x480/?1" alt="" class="rounded-lg h-80  aspect-video">
			<div class="flex flex-col justify-center flex-1 p-6 ">
				<h3 class="text-3xl font-bold uppercase">DISPOSITIVOS ATMOSFÉRICOS</h3>
				<p class="my-6 ">
                    Es de suma importancia realizar periódicamente una revisión a las instalaciones electricas con el fin de detectar los puntos de riesgo o áreas críticas que puedan originar un problema mayor, para ello contamos con el personal especializado en diversas áreas quiénes podrán ir al sitio y realizar un estudio de los puntos de riesgo
                </p>
			</div>
		</div>
		<div class="flex flex-col overflow-hidden rounded-md  lg:flex-row-reverse">
			<img src="https://source.unsplash.com/640x480/?2" alt="" class="rounded-lg h-80  aspect-video">
			<div class="flex flex-col justify-center flex-1 p-6 ">
				<h3 class="text-3xl font-bold uppercase">UPS Y BANCOS DE BATERIAS</h3>
				<p class="my-6 ">
                    Creemos que los datos y la conectividad son fundamentales para el éxito del negocio. Nuestras soluciones de energía aseguran que estén disponibles cuando y donde nuestrosclientes los necesiten. Integrando las mejores marcas del mercado
                </p>
			</div>
		</div>
		<div class="flex flex-col overflow-hidden rounded-md  lg:flex-row">
			<img src="https://source.unsplash.com/640x480/?3" alt="" class="rounded-lg h-80  aspect-video">
			<div class="flex flex-col justify-center flex-1 p-6 ">
				<h3 class="text-3xl font-bold uppercase">SISTEMAS CONTRA INCENDIOS</h3>
				<p class="my-6 ">
                    Impida perdidas humanasy materiales debido a incendios. Puedetener latranquilidad de que encasode queocurraun imprevisto,elsistemase encargaráde alertaralpersonal adecuadodeinmediato. Siempre bajo  un código de ética, con responsabilidad social y bajo las  normas actuales establecidas (NOM y NFPA)
                </p>
			</div>
		</div>
	</div>
  ...
  <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:py-25 py-20" style='background-image: url("https://sandbox.elemisthemes.com/assets/img/map.png")'>
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl"> 
          <span class="relative whitespace-nowrap text-rose-700">
              <svg aria-hidden="true" viewBox="0 0 418 42" class="absolute top-2/3 left-0 h-[0.58em] w-full fill-rose-300/70" preserveAspectRatio="none"><path d="M203.371.916c-26.013-2.078-76.686 1.963-124.73 9.946L67.3 12.749C35.421 18.062 18.2 21.766 6.004 25.934 1.244 27.561.828 27.778.874 28.61c.07 1.214.828 1.121 9.595-1.176 9.072-2.377 17.15-3.92 39.246-7.496C123.565 7.986 157.869 4.492 195.942 5.046c7.461.108 19.25 1.696 19.17 2.582-.107 1.183-7.874 4.31-25.75 10.366-21.992 7.45-35.43 12.534-36.701 13.884-2.173 2.308-.202 4.407 4.442 4.734 2.654.187 3.263.157 15.593-.78 35.401-2.686 57.944-3.488 88.365-3.143 46.327.526 75.721 2.23 130.788 7.584 19.787 1.924 20.814 1.98 24.557 1.332l.066-.011c1.201-.203 1.53-1.825.399-2.335-2.911-1.31-4.893-1.604-22.048-3.261-57.509-5.556-87.871-7.36-132.059-7.842-23.239-.254-33.617-.116-50.627.674-11.629.54-42.371 2.494-46.696 2.967-2.359.259 8.133-3.625 26.504-9.81 23.239-7.825 27.934-10.149 28.304-14.005.417-4.348-3.529-6-16.878-7.066Z"></path></svg>
              <span class="relative">JBS Go</span>
          </span>
      </h1>
      <p class="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
        En cada proyecto realiza una planeación estratégica y nos aseguramos de que incluya planos, memorias de cálculo, literatura, catálogos, manuales y especial capacitación a los operadores de los nuevos sistemas, garantizando la seguridad de los recursos humanos y reduciendo el riesgo de pérdidas económicas y desastres indeseables en las propiedades.
      </p>
  </div>


  <div class="grid grid-cols-1 gap-12 md:grid-cols-1 lg:grid-cols-2 mx-4 py-20">
    <article class="max-w-2xl mx-auto space-y-12 ">
      <div class="w-full mx-auto space-y-4 text-center">
      	<p class="text-xl font-bold tracki text-rose-700 uppercase">CDCAC</p>
      	<h1 class="text-4xl font-bold leadi md:text-5xl">Centro Deportivo Coyoacan A.C.</h1>
      </div>
      <div class=""></div>
      <div class="pt-12 border-t border-rose-700 ">
      	<div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
      		<img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=755&q=80" alt="" class="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start ">
      	...
      	<div class="flex justify-center pt-4 space-x-4 align-center"></div>
      </div>
    </article>
    
    <article class="max-w-2xl   mx-auto space-y-12 ">
      <div class="w-full mx-auto space-y-4 text-center">
      	<p class="text-xl font-bold tracki text-rose-700 uppercase">C5</p>
      	<h1 class="text-4xl font-bold leadi md:text-5xl">Centro de monitoreo C5 Pachuca.</h1>
      </div>
      <div class=""></div>
      <div class="pt-12 border-t border-rose-700 ">
      	<div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
      		...
      		<div class="flex flex-col">
      			<h4 class="text-lg font-semibold"></h4>
      			<p class="">
                    Inspeccion plantas de suministro de energía de respaldo y aparta rayos
                </p>
      		</div>
      	</div>
      	<div class="flex justify-center pt-4 space-x-4 align-center"></div>
