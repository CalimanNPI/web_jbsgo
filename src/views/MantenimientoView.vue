<template>
  ...
  <div class="bg-slate-900">
    ...
    >
      ...
      >
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          <h2
            class="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-200 sm:text-4xl sm:leading-none"
          >
            Reparación de <br class="hidden md:block" />
            <span class="inline-block text-rose-700"
              >CCTV a Nivel componente</span
            >
          </h2>
          <p class="pr-5 mb-5 text-base text-gray-700 md:text-lg">
            JBS GO pone a servicio de todos sus clientes reparaciones de cctv a
            nivel componente de diversas marcas tales como: Hanwha, Hikvision,
            Bosh, etc. Ofreciendo personal calificado y refacciones originales.
          </p>
    ...
    <div class="my-20 relative flex flex-col py-16 lg:pt-0 lg:flex-col lg:pb-0">
      ...
      >
        <svg
          class="absolute right-0 hidden h-full text-slate-900 transform translate-x-1/2 lg:block"
          viewBox="0 0 100 100"
          fill="currentColor"
          preserveAspectRatio="none slice"
        >
      ...
      >
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          <h2
            class="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-200 sm:text-4xl sm:leading-none"
          >
            Mantenimiento <br class="hidden md:block" />
            <span class="inline-block text-rose-700">Aires Acondicionados</span>
          </h2>
          <p class="pr-5 mb-5 text-base text-gray-700 md:text-lg">
            Contamos con ingenieria certificada en diversos ramos de la
            industria ofreciendo servicios de ingeniería, mantenimiento e
            instalación. Gracias a nuestra asociación en Master Channel
            tenemospresencia en las ciudades mas importantes del país.
          </p>
          <div class="flex items-center"></div>
        </div>
      </div>
      ...
      >
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          <h2
            class="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-200 sm:text-4xl sm:leading-none"
          >
            <span class="inline-block text-rose-700">Mantenimiento</span>
            <br class="hidden md:block" />
            sistemas contra incendios y recarga de extintore
          </h2>
          <p class="pr-5 mb-5 text-base text-gray-700 md:text-lg">
            Contar con la confianza de que un sistema de seguridad sea util
            cuando menos se le espere es de vital importancia para la protección
