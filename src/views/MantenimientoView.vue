...
<div class="bg-slate-900 px-10">
    <div class="flex flex-col items-center justify-between lg:flex-row">
      <div class="mx-auto max-w-screen-xl lg:flex lg:h-screen lg:items-center flex flex-1 w-full flex-col items-center justify-center text-center">
        <h1  class="leading-snug mx-auto max-w-4xl font-display text-4xl font-bold tracking-normal text-slate-200 sm:text-4xl">
            Mantenimiento y
          <span class="relative whitespace-nowrap text-rose-700">
            <svg aria-hidden="true" viewBox="0 0 418 42" class="absolute top-2/3 left-0 h-[0.58em] w-full fill-slate-50/70" preserveAspectRatio="none">
    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="mt-8 xl:mt-12 lg:flex lg:items-center">
            <div class="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                <div class="space-y-3">
                    <span class="inline-block p-3 text-rose-700 bg-rose-100 rounded-xl  ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                    </span>
                    <h1 class="text-xl font-semibold text-slate-700 capitalize ">Mantenimiento e inspección de AA</h1>
                ...
                <div class="space-y-3">
                    ...
                    <h1 class="text-xl font-semibold text-slate-700 capitalize ">Reemplazo de acumuladores y mantenimiento de UPS</h1>
                    <p class="text-slate-500 "></p>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <h1 class="text-xl font-semibold text-slate-700 capitalize ">Reparacion y mantenimiento de CCTV y equipo de computo</h1>
                    <p class="text-slate-500 "></p>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <h1 class="text-xl font-semibold text-slate-700 capitalize ">Recarga y Mantenimineto de extintores</h1>
                    <p class="text-slate-500 "></p>
                </div>
            </div>
...
<section class="p-4 lg:p-8 bg-slate-900 text-slate-200">
	<div class="container mx-auto space-y-12">
		<div class="flex flex-col overflow-hidden rounded-md lg:flex-row">
			...
			<div class="flex flex-col justify-center flex-1 p-6 ">
				<h3 class="text-3xl font-bold uppercase">Reparación de CCTV a Nivel componente</h3>
				<p class="my-6 ">
                    JBS GO pone a servicio de todos sus clientes reparaciones de cctv a nivel componente de diversas marcas tales como: Hanwha, Hikvision, Bosh, etc. Ofreciendo personal calificado y refacciones originales.
                </p>
			</div>
		</div>
		<div class="flex flex-col overflow-hidden rounded-md  lg:flex-row-reverse">
			...
			<div class="flex flex-col justify-center flex-1 p-6 ">
				<h3 class="text-3xl font-bold uppercase">Mantenimiento Aires Acondicionados</h3>
				<p class="my-6 ">
                    Contamos con ingenieria certificada en diversos ramos de la industria ofreciendo servicios de ingeniería, mantenimiento e instalación. Gracias a nuestra asociación en Master Channel tenemospresencia en las ciudades mas importantes del país.
                </p>
			</div>
		</div>
		<div class="flex flex-col overflow-hidden rounded-md  lg:flex-row">
			...
			<div class="flex flex-col justify-center flex-1 p-6 ">
				<h3 class="text-3xl font-bold uppercase">Mantenimiento sistemas contra incendios y recarga de extintores</h3>
				<p class="my-6 ">
                    Contar con la confianza de que un sistema de seguridad sea util cuando menos se le espere es de vital importancia para la protección de nuestros clientes.
                </p>
			</div>
		</div>
	</div>
  ...
  <div class="bg-slate-200 text-slate-900 py-20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-8 lg:flex-row items-center">
            <div class="lg:w-1/2">
                <h1 class="text-4xl font-bold leading-tight mb-4"></h1>
                <p class="text-xl mb-8">
                    Nuestro compromiso es servir y ofrecer soluciones en conjunto con nuestros clientes. Gracias a ello se forma un puente de confianza y comunicación que favorece desarrollar proyectos. El contar con Ingeniería certificada, personal honesto y experto en el tema, garantiza nuestra labor y la recurrencia de quien nos contrata
                </p>
            </div>
